...
class SLidr_Options {
	...
	public function display_setting( $args = array() ) {
		...
		switch ( $type ) {
			...
			case 'textarea':
				echo '<textarea class="' . $field_class . '" id="' . $id . '" name="slidr_options[' . $id . ']" placeholder="' . $std . '" rows="5" cols="30">' . wp_htmledit_pre( $options[$id] ) . '</textarea>';
